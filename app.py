...
commands = {
    ...
    "we": lambda: p.clear_auxiliary_relay(1), # stop wiper
    "180": lambda: p.flip_180_about(),        # flip 180 degrees
    "m": lambda: p.set_auxiliary_relay(95),   # open menu
    "sp1": lambda: p.set_preset(1),           # set preset 1
    "sp2": lambda: p.set_preset(2),           # set preset 2
    "sp3": lambda: p.set_preset(3),           # set preset 3
    "gp1": lambda: p.go_to_preset(1),         # go to preset 1
    "gp2": lambda: p.go_to_preset(2),         # go to preset 2
    "gp3": lambda: p.go_to_preset(3),         # go to preset 3
}
